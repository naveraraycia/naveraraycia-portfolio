...
export const thesis = {
  ...
  subHeading2: {
    ...
    description: 'At least now I am very proud to say that I have improved immensely since compared to before, now I could produce full-stack websites that are built using latest frameworks and technologies. Also, at least now I already know how to upload files to an online bucket and successfully host my dynamic sites.'
  },
