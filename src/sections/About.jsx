  ...
  return (
    <section className={`overflow-x-hidden px-5 pb-32 space-y-10 ${darkMode === true ? 'bg-base-100' : 'bg-light-base-100'} duration-300 sm:pt-5 md:px-32 xl:space-y-32`}>
      ...
      <div data-aos='fade-up' data-aos-delay='400' >
        <div className={`flex flex-col items-center space-y-10 ${darkMode === true ? 'text-white' : 'text-neutral'} md:space-y-16 xl:flex-row xl:space-y-0 xl:space-x-40`}>
          {/* Description */}
          <div className="relative w-full space-y-4 lg:w-fit">
            <div className={`${darkMode && 'opacity-60'}`}>
              <div className={`absolute w-[400px] h-[400px] top-10 blur-3xl left-24 rounded-full ${darkMode === true ? 'bg-[#6A25C7]' : 'bg-[#C4F7FC]'}`}></div>
            ...
            <div className={`z-50 text-sm relative space-y-10 max-w-[700px] ${darkMode === true ? 'text-white' : 'text-neutral'}`}>
