...
function About() {
  ...
  return (
    <section id="about" className={`px-5 pt-40 pb-60 md:px-32 space-y-20 ${darkMode === true ? 'bg-base-100' : 'bg-light-base-100'} duration-300 xl:space-y-96`}>
      ...
      <div className={`flex flex-col items-center space-y-14 ${darkMode === true ? 'text-white' : 'text-neutral'} md:space-y-32 xl:flex-row xl:space-y-0 xl:space-x-40`}>
        ...
        <div className="relative w-full space-y-4 lg:w-fit">
          ...
          <div className={`z-50 relative space-y-14 max-w-[700px] ${darkMode === true ? 'text-white' : 'text-neutral'}`}>
        ...
        {/* Personal Details */}
        <div className="space-y-10 w-full max-w-[700px] xl:w-fit">
      ...
      <div className={`relative flex flex-col items-center ${darkMode === true ? 'text-white' : 'text-neutral'} xl:flex-row xl:justify-center`}>
        ...
        <div className="relative mr-5 px-5 z-20 space-y-5 order-2 mt-6 xl:order-1 xl:mt-0">
          ...
          <div tabIndex={1} className={`collapse collapse-arrow duration-300 ${darkMode === true ? 'bg-neutral' : 'bg-white'} bg-opacity-30`}>  
          <div className="collapse-title text-md font-black flex items-center uppercase space-x-10 hover:cursor-pointer xl:text-xl">
          ...
          <div tabIndex={2} className={`collapse collapse-arrow duration-300 ${darkMode === true ? 'bg-neutral' : 'bg-white'} bg-opacity-30`}> 
          <div className="collapse-title text-md font-black flex items-center uppercase space-x-10 hover:cursor-pointer xl:text-xl">
        ...
        <div className={`${darkMode === true ? 'text-white' : 'text-neutral'} mt-40 relative text-center flex flex-col  justify-right order-1 xl:order-2 xl:text-right z-20 xl:mt-0`}>
          ...
          <p className="text-lg">These are more stuff about me unrelated to tech</p>
        </div>
      </div>
    </section>
  )
