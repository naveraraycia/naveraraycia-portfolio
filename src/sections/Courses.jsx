...
function Courses() {
  ...
  return (
    <section  id="courses" className={`relative ${darkMode ? 'dark-course text-white' : 'light-course text-neutral'} duration-300`}>
      ...
      <div data-aos='fade-up' data-aos-delay='200' className={`container mx-auto px-5 pb-10 h-fit relative z-20 duration-300 sm:pb-60 lg:h-[900px] xl:h-[750px] sm:pt-40`}>
