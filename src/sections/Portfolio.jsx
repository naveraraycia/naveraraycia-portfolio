...
function Portfolio() {
  ...
  return (
    <section id="portfolio" className={`px-5 pt-5 pb-32 sm:py-40 md:px-32 ${darkMode ? 'bg-base-100' : 'bg-light-base-100'} duration-300`}>
      <div className="container mx-auto px-5 space-y-5 sm:space-y-10">
