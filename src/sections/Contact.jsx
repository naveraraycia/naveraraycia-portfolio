...
function Contact() {
  ...
  return (
    <section id="contact" className={`${darkMode === true ? 'text-white bg-base-100' : 'bg-light-base-100 text-neutral'} duration-300`}>

      <div className={`px-5 pb-10 md:px-32 space-y-20 duration-300`}>
