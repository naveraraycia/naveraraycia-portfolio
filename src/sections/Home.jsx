              ...
              <div className="md:space-y-3 xl:-space-y-1">
                  <div className="-space-y-1 sm:-space-y-2 lg:space-y-0 xl:-space-y-5">
                    ...
                    <div data-aos='fade-right' data-aos-delay='700'>
                      <h1 className={`font-black text-5xl ${darkMode === true ? 'text-white' : 'text-transparent bg-clip-text bg-gradient-to-r from-secondary to-primary'} sm:leading-none sm:text-6xl lg:leading-none xl:text-7xl xl:leading-normal`}>Raycia Navera.</h1>
                    </div>
                  </div>
