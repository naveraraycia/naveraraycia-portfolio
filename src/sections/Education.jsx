          ...
          <div className="space-y-16">
            <div className="relative w-full space-y-4 lg:w-fit">
              <div className={`${darkMode && 'opacity-80'}`}>
                <div className={`absolute w-[400px] h-[400px] top-20 blur-3xl -left-5 rounded-full ${darkMode ? 'bg-[#6A25C7]' : 'bg-[#C4F7FC]'}`}></div>
                <div className={`absolute w-[400px] top-36 left-20 blur-3xl h-[400px] rounded-full ${darkMode ? 'bg-[#F857E7]' : 'bg-[#FEBEFF]'}`}></div>
              </div>
